...
export type TwitterTweetParams = { url: string }
export type TwitterUserTweetsParams = { handle: string; cursor?: string }
export type TwitterTranscriptParams = { url: string; language?: string }
export type TwitterCommunityParams = { url: string }
export type TwitterCommunityTweetsParams = { url: string; cursor?: string }
...
export class Twitter {
  ...
  transcript(params: TwitterTranscriptParams, options?: RequestOptions) {
    return this.client.get<JsonRecord>('/twitter/transcript', params, options)
  }
